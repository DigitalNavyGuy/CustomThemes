...
function b2w_assets() {
    ...
    // Enqueue CSS Files
    wp_enqueue_style( 'google-font', '//fonts.googleapis.com/css2?family=Inter:wght@100..900&display=swap', array(), '1.0', 'all');
    ...
    // Enqueue JS Files
    // Don't enqueue jQuery files. They will be loaded from WordPress when required.
